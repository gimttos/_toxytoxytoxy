/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv ./cloudflare-env.d.ts` (hash: 49875912e35e7b0be67eea177c78a526)
// Runtime types generated with workerd@1.20260515.1 2026-05-19 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_CloudflareEnv {
	DB: D1Database;
	pal3bluedot_db: D1Database;
	IMAGES: ImagesBinding;
	ASSETS: Fetcher;
	NEXTJS_ENV: string;
	OWNER_SECRET: string;
	WORKER_SELF_REFERENCE: Fetcher /* my-site */;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXTJS_ENV" | "OWNER_SECRET">> {}
}
